...
namespace Photon.Pun.UtilityScripts
{
    ...
    public class PhotonStatsGui : MonoBehaviour
    {
        ...
        void UpdateBuffer () {
            fpsBuffer[fpsIndexBuffer++] = (int)(1f / Time.unscaledDeltaTime);
            if (fpsIndexBuffer >= frameRange) 
                fpsIndexBuffer = 0;
        ...
        public static PhotonStatsGui Instance;
        public void Start()
        {
        ...
        public void TrafficStatsWindow(int windowID)
        {
            ...
            this.fpsOn = GUILayout.Toggle(this.fpsOn, "fps");
            ...
            string fpsStats = string.Empty;
            if (this.fpsOn)
            {
                GUILayout.Box("FPS");
                GUILayout.Label($"Average FPS: {AverageFPS}");
